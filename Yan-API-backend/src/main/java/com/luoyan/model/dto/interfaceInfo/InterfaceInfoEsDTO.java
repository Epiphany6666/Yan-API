...
public class InterfaceInfoEsDTO implements Serializable {
     ...
     * @return
     */
    public static InterfaceInfoEsDTO objToDto(Post post) {
        if (post == null) {
            return null;
        }
        InterfaceInfoEsDTO postEsDTO = new InterfaceInfoEsDTO();
     ...
     * @return
     */
    public static Post dtoToObj(InterfaceInfoEsDTO postEsDTO) {
        if (postEsDTO == null) {
            return null;
        }
        Post post = new Post();
